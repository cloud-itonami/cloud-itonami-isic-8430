# Operator Quickstart — Compulsory Social Security Administration

Shortest path from clone to a verified local dry-run for **ISIC 8430** (`cloud-itonami-isic-8430`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8430.git
cd cloud-itonami-isic-8430
```
...
- Blueprint governor key: `social-security-governor`
- Likely source path: `social_security.governor.cljc`
